  ...
  return (
    <div className='sidenav'>
      <div className='logo'>
        ...
        <Link to='/profile'><img src ={userProfile.image ? `https://pavanipampana.pythonanywhere.com/${userProfile.image}` : 'default-profile-pic-url'} alt="User Profile" className='profile-pic' /></Link>
      </div>
